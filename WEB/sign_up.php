...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Set the subscriptionExpireDate to the current date
    $subscriptionExpireDate = date('Y-m-d H:i:s');

    // Insert user data into database
    $sql = "INSERT INTO customers (customerId, firstName, surname, email, password, phoneNumber, subscriptionExpireDate)
            VALUES ('$customerId', '$firstName', '$surname', '$email', '$hashedPassword', '$phoneNumber', '$subscriptionExpireDate')";
...
<div class="container">
    <form id="spectatorForm" class="login-form" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
        ...
        <div class="under_links">
            <a class="translatable" href="demand_acc_organiser.php?lang=<?php echo $lang; ?>" data-translation-key="organiserRequestPrompt"></a>
        </div>
    </form>
...
<script>
    document.getElementById('spectatorForm').addEventListener('submit', function(event) {
