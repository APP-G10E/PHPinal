<footer>
    ...
    <div class="container-liens">
        ...
        <div><p class="footer-link translatable" data-translation-key="footerCGV" id="footerCGV"></p></div>
        <div><p class="footer-link translatable" data-translation-key="contactUs" id="footerContactUs"></p></div>
        <div><p class="footer-link translatable" data-translation-key="footerFAQ" id="footerFAQ"></p></div>
    </div>
    <br>
